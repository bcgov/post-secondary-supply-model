...
INTO tmp_qry18b_ExtrLaterAwarded_2
...
qry18c_ExtrLaterAwarded <- 
"SELECT tmp_qry18b_ExtrLaterAwarded_2.concatenated_id, 
Max(tmp_qry18b_ExtrLaterAwarded_2.LATER_AWARD_DATE) AS MaxOfLATER_AWARD_DATE
INTO tmp_qry18c_ExtrLaterAwarded_3
FROM tmp_qry18b_ExtrLaterAwarded_2
GROUP BY tmp_qry18b_ExtrLaterAwarded_2.concatenated_id;"

# ---- qry18d_ExtrLaterAwarded ----
qry18d_ExtrLaterAwarded <- 
"SELECT DISTINCT Min(tmp_qry18b_ExtrLaterAwarded_2.LID) AS LID, 
        tmp_qry18b_ExtrLaterAwarded_2.HID, 
        tmp_qry18b_ExtrLaterAwarded_2.concatenated_id, 
        tmp_qry18b_ExtrLaterAwarded_2.LATER_AWARD_DATE, 
        tmp_qry18b_ExtrLaterAwarded_2.PSI_AWARD_SCHOOL_YEAR 
INTO    tblCredential_DelayEffect
FROM    tmp_qry18b_ExtrLaterAwarded_2 
INNER JOIN tmp_qry18c_ExtrLaterAwarded_3 
  ON    tmp_qry18b_ExtrLaterAwarded_2.LATER_AWARD_DATE = tmp_qry18c_ExtrLaterAwarded_3.MaxOfLATER_AWARD_DATE
  AND   tmp_qry18b_ExtrLaterAwarded_2.concatenated_id = tmp_qry18c_ExtrLaterAwarded_3.concatenated_id
GROUP BY 
        tmp_qry18b_ExtrLaterAwarded_2.HID, 
        tmp_qry18b_ExtrLaterAwarded_2.concatenated_id, 
        tmp_qry18b_ExtrLaterAwarded_2.LATER_AWARD_DATE, 
...
FROM    tblCredential_HighestRank 
INNER JOIN tblCredential_DelayEffect ON tblCredential_HighestRank.ID = tblCredential_DelayEffect.HID;"
