...
SELECT  surv_cohort_collection_info.coci_pen,
        ...
        l_cip_6digits_cip2021.lcip_lcippc_name,
        l_cip_6digits_cip2021.lcp6_cd,
        l_cip_4digits_cip2021.lcp4_cd,
        l_cip_4digits_cip2021.lcp4_digits_name,
...
RIGHT JOIN ((surv_cohort_collection_info
  INNER JOIN (programs
    INNER JOIN (l_cip_6digits_cip2021
      INNER JOIN l_cip_4digits_cip2021
...
WHERE  (( surv_cohort_collection_info.coci_subm_cd = 'C_Outc25' OR
          surv_cohort_collection_info.coci_subm_cd = 'C_Outc24' OR
          surv_cohort_collection_info.coci_subm_cd = 'C_Outc23' OR
          surv_cohort_collection_info.coci_subm_cd = 'C_Outc22' OR
          surv_cohort_collection_info.coci_subm_cd = 'C_Outc21')
  AND     l_cip_6digits_cip2021.lcip_lcippc_name  <> 'Developmental'
  AND     l_cip_6digits_cip2021.lcip_lcippc_name  <> 'Personal Improvement and Leisure')
