SELECT 'TRD' AS Survey,
       ...
       -- gradstat_group || ' - ' || l_cip_6digits_cip2021.lcip_lcp4_cd || ' - ' || trades_cohort_info.ttrain || ' - ' || PSSM_Credential AS LCIP4_CRED,
...
WHERE         trades_cohort_info.subm_cd = 'C_Outc25'
           OR trades_cohort_info.subm_cd = 'C_Outc24'
           OR trades_cohort_info.subm_cd = 'C_Outc23'
