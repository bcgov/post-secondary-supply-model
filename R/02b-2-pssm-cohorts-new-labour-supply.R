...
# [SELECT INTO] Create DACSO_Q99A_STQUI_ID from T_Cohorts_Recoded
...
# [SELECT INTO] Create DACSO_Q005_DACSO_DATA_Part_1c_NLS1 from t_cohorts_recoded
...
# [SELECT INTO] Create DACSO_Q005_DACSO_DATA_Part_1c_NLS2 from t_cohorts_recoded
...
# [SELECT INTO] Create DACSO_Q005_Z01_Base_NLS from t_cohorts_recoded
...
# [SELECT INTO] Create DACSO_Q005_Z02c_Weight_tmp from t_cohorts_recoded
...
# [SELECT INTO] Create DACSO_Q005_Z02c_Weight from DACSO_Q005_Z02c_Weight_tmp
...
# [SELECT INTO] Create DACSO_Q005_Z03_Weight_Total from dacso_q005_z02c_weight
...
# [SELECT INTO] Create DACSO_Q005_Z04_Weight_Adj_Fac from dacso_q005_z03_weight_total
...
# [SELECT INTO] Create tmp_tbl_weights_nls from dacso_q005_z02c_weight
...
# [SELECT INTO] Create DACSO_Q006a_Weight_New_Labour_Supply from t_cohorts_recoded
...
# [SELECT INTO] Create dacso_q006b_weighted_new_labour_supply from dacso_q006a_weight_new_labour_supply
...
# [SELECT INTO] Create DACSO_Q006b_Weighted_New_Labour_Supply_0 from DACSO_Q006a_Weight_New_Labour_Supply
...
# [SELECT INTO] Create DACSO_Q006b_Weighted_New_Labour_Supply_0_2D from DACSO_Q006a_Weight_New_Labour_Supply
...
# [SELECT INTO] Create dacso_q006b_weighted_new_labour_supply_0_2d_no_tt from dacso_q006a_weight_new_labour_supply
...
# [SELECT INTO] Create dacso_q006b_weighted_new_labour_supply_0_no_tt from dacso_q006a_weight_new_labour_supply
...
# [SELECT INTO] Create DACSO_Q006b_Weighted_New_Labour_Supply_2D from DACSO_Q006a_Weight_New_Labour_Supply
...
# [SELECT INTO] Create dacso_q006b_weighted_new_labour_supply_2d_no_tt from dacso_q006a_weight_new_labour_supply
...
# [SELECT INTO] Create dacso_q006b_weighted_new_labour_supply_no_tt from dacso_q006a_weight_new_labour_supply
...
# [SELECT INTO] Create dacso_q006b_weighted_new_labour_supply_total from dacso_q006a_weight_new_labour_supply
...
# [SELECT INTO] Create DACSO_Q006b_Weighted_New_Labour_Supply_Total_2D from DACSO_Q006a_Weight_New_Labour_Supply
...
# [SELECT INTO] Create DACSO_Q006b_Weighted_New_Labour_Supply_Total_2D_No_TT from DACSO_Q006a_Weight_New_Labour_Supply
...
# [SELECT INTO] Create dacso_q006b_weighted_new_labour_supply_total_no_tt from DACSO_Q006a_Weight_New_Labour_Supply
...
# [SELECT INTO] Create DACSO_Q007a_Weighted_New_Labour_Supply from DACSO_Q006b_Weighted_New_Labour_Supply_Total
...
# [SELECT INTO] Create DACSO_Q007a_Weighted_New_Labour_Supply_0 from DACSO_Q006b_Weighted_New_Labour_Supply_Total
...
# [SELECT INTO] Create DACSO_Q007a_Weighted_New_Labour_Supply_0_2D from DACSO_Q006b_Weighted_New_Labour_Supply_Total_2D
...
# [SELECT INTO] Create DACSO_Q007a_Weighted_New_Labour_Supply_0_2D_No_TT from DACSO_Q006b_Weighted_New_Labour_Supply_Total_2D_No_TT
...
# [SELECT INTO] Create DACSO_Q007a_Weighted_New_Labour_Supply_0_No_TT from DACSO_Q006b_Weighted_New_Labour_Supply_Total_No_TT
...
# [SELECT INTO] Create DACSO_Q007a_Weighted_New_Labour_Supply_2D from DACSO_Q006b_Weighted_New_Labour_Supply_Total_2D
...
# [SELECT INTO] Create DACSO_Q007a_Weighted_New_Labour_Supply_2D_No_TT from DACSO_Q006b_Weighted_New_Labour_Supply_Total_2D_No_TT
...
# [SELECT INTO] Create DACSO_Q007a_Weighted_New_Labour_Supply_No_TT from DACSO_Q006b_Weighted_New_Labour_Supply_Total_No_TT
...
# [DELETE] Labour_Supply_Distribution_No_TT_QI
...
# [DELETE] Labour_Supply_Distribution_LCP2
...
# [DELETE] Labour_Supply_Distribution_LCP2_No_TT_QI
...
# [DELETE] Labour_Supply_Distribution_LCP2_QI
...
# [INSERT INTO] Labour_Supply_Distribution_LCP2
