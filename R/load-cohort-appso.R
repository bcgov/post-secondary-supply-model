...
T_APPSO_DATA_Final <- dbReadTable(
  decimal_con,
  SQL(glue::glue('"{my_schema}"."APPSO_DATA_01_Final_raw"'))
)
APPSO_Graduates_dat <- dbReadTable(
  decimal_con,
  SQL(glue::glue('"{my_schema}"."APPSO_Graduates_raw"'))
)
