...
STTP_Credential_Non_Dup_Programs_DACSO.FINAL_CIP_CLUSTER_CODE = [INFOWARE_L_CIP_6DIGITS_CIP2016].[LCIP_LCIPPC_CD],
STTP_Credential_Non_Dup_Programs_DACSO.FINAL_CIP_CLUSTER_NAME = [INFOWARE_L_CIP_6DIGITS_CIP2016].[LCIP_LCIPPC_NAME]
