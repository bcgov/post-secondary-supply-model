...
dbGetQuery(decimal_con, Q_1b_Checking_Grads_by_Year_Excludes_CIPs)  # make pivot from transform
...
dbExecute("DROP TABLE Q_2_Labour_Supply_by_LCIP4_CRED")
dbExecute("DROP TABLE Q_2a_Labour_Supply_Unknown")
dbExecute("DROP TABLE Q_2a2_Labour_Supply_Unknown_No_TT_Proxy")
dbExecute("DROP TABLE Q_2a3_Labour_Supply_by_LCIP4_CRED_No_TT_Proxy_Union")
dbExecute("DROP TABLE tmp_tbl_Q_2a4_Labour_Supply_by_LCIP4_CRED_No_TT_Union_tmp")
dbExecute("DROP TABLE Q_2b_Labour_Supply_Unknown")
dbExecute("DROP TABLE Q_2b2_Labour_Supply_Unknown_Private_Cred_Proxy")
dbExecute("DROP TABLE Q_2b3_Labour_Supply_by_LCIP4_CRED_Private_Cred_Proxy_Union")
dbExecute("DROP TABLE Q_2b4_Labour_Supply_Unknown")
dbExecute("DROP TABLE Q_2c_Labour_Supply_Unknown_LCP2_Proxy")
dbExecute("DROP TABLE Q_2c2_Labour_Supply_Unknown_LCP2_Proxy_Union")
dbExecute("DROP TABLE Q_2c3_Labour_Supply_Unknown")
dbExecute("DROP TABLE Q_2c4_Labour_Supply_Unknown_LCP2_Proxy_No_TT")
dbExecute("DROP TABLE Q_2d_Labour_Supply_by_LCIP4_CRED_LCP2_Union")
dbExecute("DROP TABLE tmp_tbl_Q_2d_Labour_Supply_by_LCIP4_CRED_LCP2_Union_tmp")
dbExecute("DROP TABLE Q_2d2_Labour_Supply_Unknown")
dbExecute("DROP TABLE Q_2d3_Labour_Supply_Unknown_LCP2_Private_Cred_Proxy")
dbExecute("DROP TABLE Q_2d4_Labour_Supply_by_LCIP4_CRED_LCP2_LCP2_Private_Union")
dbExecute("DROP TABLE tmp_tbl_Q_2d_Labour_Supply_by_LCIP4_CRED_LCP2_Union")
dbExecute("DROP TABLE Q_2f_Labour_Supply")
...
dbExecute(decimal_con, Q_4_NOC_Totals_by_PSSM_CRED) 
dbExecute(decimal_con, Q_4_NOC_Totals_by_Year) 
dbExecute(decimal_con, Q_4_NOC_Totals_by_Year_and_PSSM_CRED) 
